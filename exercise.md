...
- If possible it should have an automated build pipeline using https://travis-ci.org/ for instance.
...
- Use **logging**.
- Should create generic functions for filtering data and renaming.
